@section('title', $author_name. ' | M Blog' )
<div class="col-lg-8 mb-2 g-0">
    ...
    <div class="row g-0">
        <div class="col w-100 text-center mb-3" style="font-size: 22px;">All Post by Author: <span style="font-weight: 600">{{ $author_name }}</span></div>
        ...
        <div class="blog-card g-0 mb-4" style="margin:0px">
            <div class="meta">
                ...
                @endif
                <ul class="details">
                    <li class="author">{{ $post->users->name }}</li>
