            ...
            <div class="d-flex justify-content-center row g-0">
                <div class="col-md-12">
                    <div class="d-flex flex-column comment-section">
                        <div class="g-0 p-1 row w-100">
                            <div class="col-1 g-0" style="max-width: 45px"><img class="rounded-circle" title="{{ $comment->users->name }}" src="{{ $comment->users->profile_photo_url }}" width="40" height="35"></div>
