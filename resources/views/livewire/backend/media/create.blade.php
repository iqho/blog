            ...
            <form id="updateform" method="" action="" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 text-center align-middle">
                        ...
                        @else
                        <div class="col-12 text-center w-100"><img src="{{ asset('backend/assets/images/slider/03.jpg') }}" class="img-fluid img-thumbnail rounded"></div>
                        @endif
                            ...
                            <div class="col-12">Image Details</div>
                        </div>
