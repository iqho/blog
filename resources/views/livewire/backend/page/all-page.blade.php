            ...
            <div class="col-12">
                <div class="card p-1">
                    <div class="card-header border-bottom">
                        <div class="row w-100">
                            <div class="col-6"><h1 class="card-title" style="font-size: 28px">Display All Pages</h1></div>
                            <div class="col-6"><a class="btn btn-primary" href="{{ route('admin-panel.page-create') }}">Create New Page</a></div>
                        </div>
                        ...
                        <table id="postsTable" class="table table-bordered table-hover dt-responsive" style="width:100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($data['pages'] as $page)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td><a href="{{ route('page.single-page', $page->slug) }}" target="_blank">{{ $page->title }}</a></td>
                                        <td>{{ $page->slug }}</td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a href="#" class="dropdown-item"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 me-50 font-small-4"><polyline points="3 6 5 6 21 6"></polyline>
                                                            ...
                                                            <a href="{{ route('admin-panel.edit-page', $page->id) }}" class="item-edit">
